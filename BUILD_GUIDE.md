...
**Expected result:** 116 passed, 1 failed, 2 skipped. The 1 failure is ttnn_add_int_silicon (requires real hardware). The 2 skips are `test_emulation_toggle` (not yet in CMakeLists).
