...
**Success:** Output ends with `Results: 126 passed, 1 failed, 2 skipped` and exit code 1. The 2 skips are `test_emulation_toggle` (not yet in CMakeLists). Known failure: ttnn_add_int_silicon (requires real hardware).
