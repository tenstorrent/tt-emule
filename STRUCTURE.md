...
- `include/jit_hw/api/compute/reduce.h` — `__emule_reduce_col_into_dst` (global); `ckernel::` `reduce_tile`, `reduce_init`, `reduce_tile_math`; `REDUCE_OP`/`REDUCE_DIM`
