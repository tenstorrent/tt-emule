...
// Emule shadow for blaze's custom `deepseek_moe_gate` compute op.
//
// Post-#1383 ("Get rid of all relative includes"), blaze kernels include this
// header by its repo-root-rooted path
//   blaze/kernels/kernel_includes/tt_metal/include/compute_kernel_api/deepseek_moe_gate.h
...
#include "api/compute/deepseek_moe_gate.h"
