...
struct ComputeThreadCtx : ThreadCommonCtx {
    ...
    uint32_t llk_unpack_start_tile_idx = 0;  // was __emule_compute_ctx().llk_unpack_start_tile_idx
    uint32_t llk_unpack_block_c = 0;         // was __emule_compute_ctx().llk_unpack_block_c
    uint32_t llk_unpack_current_tile = 0;    // was __emule_compute_ctx().llk_unpack_current_tile
    bool     llk_unpack_is_tilize = false;   // was __emule_compute_ctx().llk_unpack_is_tilize
    uint32_t llk_pack_offset = 0;            // was __emule_compute_ctx().llk_pack_offset
    bool     llk_pack_is_untilize = false;   // was __emule_compute_ctx().llk_pack_is_untilize
    uint32_t llk_pack_block_c = 0;           // was __emule_compute_ctx().llk_pack_block_c
