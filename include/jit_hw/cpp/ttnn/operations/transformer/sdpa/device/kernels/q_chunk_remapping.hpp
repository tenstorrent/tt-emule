...
// includes `cpp/ttnn/operations/transformer/sdpa/device/kernels/q_chunk_remapping.hpp`
...
// portable zigzag/index math stays owned by tt-metal, compiled verbatim.

#include "ttnn/operations/transformer/sdpa/device/kernels/q_chunk_remapping.hpp"
