...
// Non-templated overloads called by moreh_common.hpp wrappers (e.g. *_with_dt)
inline void add_bcast_cols_init_short(uint32_t icb0 = 0, uint32_t icb1 = 1) {}
inline void add_bcast_scalar_init_short(uint32_t icb0 = 0, uint32_t icb1 = 1) {}
inline void sub_tiles_bcast_scalar_init_short(uint32_t icb0 = 0, uint32_t icb1 = 1) {}
inline void mul_tiles_bcast_scalar_init_short(uint32_t icb0 = 0, uint32_t icb1 = 1) {}
inline void mul_tiles_bcast_scalar(uint32_t /*icb0*/, uint32_t /*icb1*/,
