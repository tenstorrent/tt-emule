...
**126 passed, 11 failed, 0 skipped** against `arminale/emule-metal-base` @ `c812fbb1cc` (baseline 2026-05-01). All 11 failures are DFB STRIDED wraparound (Tier 3b, ×4) + DFB Config Validation (Tier 3g, ×7) — see `IMPLEMENTATION_REPORT.md` § "Changes from v9 to v10" for the list.
